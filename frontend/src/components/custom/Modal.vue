  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        <div 
          ref="contentRef"
          class="modal-content relative z-content w-full rounded-2xl bg-background/95 backdrop-blur-md border border-border/30 shadow-cartoon-lg overflow-hidden flex flex-col"
