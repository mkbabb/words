    ...
    const containerStyle = computed(() => {
        ...
        if (isInteractive.value) {
            return {
                ...
                transform: 'scale(1)',
                opacity: '1',
                transition: `transform var(--duration-normal, 0.3s) var(--ease-out), opacity var(--duration-normal, 0.3s) var(--ease-out)`,
            };
        }
        ...
        return {
            ...
            transition: `transform var(--duration-fast, 0.2s) var(--ease-out), opacity var(--duration-fast, 0.2s) var(--ease-out)`,
        };
    });
