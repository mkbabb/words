<template>
  ...
  >
    ...
    <button
      class="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground shadow-cartoon-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-ring"
      @click="retry"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
