                    ...
                    <HoverCardTrigger as-child>
                        ...
                        >
                            <div class="p-3">
                                ...
                                <!-- Metrics -->
                                <div
                                    class="mt-3 flex gap-4 text-xs text-muted-foreground"
                                >
                                    <span
                                        >Relevance:
                                        {{
                            ...
                            <!-- Click indicator -->
                            <div
                                class="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-transparent via-primary/50 to-transparent opacity-0 transition-opacity group-hover:opacity-100"
                            />
                        </ThemedCard>
                    </HoverCardTrigger>
