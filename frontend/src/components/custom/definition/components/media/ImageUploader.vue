<template>
    <div class="relative">
        ...
        <button
            v-if="variant === 'empty'"
            class="flex h-full w-full flex-col items-center justify-center text-muted-foreground hover-lift-md hover:text-foreground"
        ...
        <Transition name="progress-fade">
            <div
                ...
                class="absolute inset-x-0 bottom-0 rounded-b-lg bg-black/60 py-1 text-center text-xs text-white"
            >
                {{ uploadProgress }}%
            </div>
        </Transition>
