<template>
    ...
    >
        <div class="mb-6">
            <div
                class="relative mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-muted/20"
            >
                <component
                    :is="emptyIcon"
                    :size="32"
...
import { SearchX, FileText, BookOpen, Lightbulb } from 'lucide-vue-next';
