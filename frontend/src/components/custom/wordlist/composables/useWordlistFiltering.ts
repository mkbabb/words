...
export function useWordlistFiltering(words: Ref<WordListItem[]>) {
    ...
    const filteredWords = computed(() => {
        ...
        if (
            filters.value.mastery.length > 0 &&
            filters.value.mastery.length < 3
        ) {
            ...
            sorted.sort((a, b) => {
                ...
                switch (key) {
                    ...
                    case 'mastery':
                        ...
                        aVal =
                            masteryOrder[
                                a.mastery_level as keyof typeof masteryOrder
                            ] || 0;
                        bVal =
                            masteryOrder[
                                b.mastery_level as keyof typeof masteryOrder
                            ] || 0;
                        break;
                    case 'temperature':
                        ...
                        aVal =
                            tempOrder[
                                a.temperature as keyof typeof tempOrder
                            ] || 0;
                        bVal =
                            tempOrder[
                                b.temperature as keyof typeof tempOrder
                            ] || 0;
                        break;
                    case 'next_review':
                        aVal = new Date(
