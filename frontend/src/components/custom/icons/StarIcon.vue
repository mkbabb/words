<template>
    <div :class="cn('h-10 w-10 transition-normal', starClasses)">
        ...
        <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            class="relative z-content h-full w-full drop-shadow-sm"
        >
            <path
...
<!-- Animation keyframes & utility classes extracted to @/assets/transitions.css:
     .star-shimmer-{gold,silver,bronze}, @keyframes star-shimmer-{gold,silver,bronze}
-->
