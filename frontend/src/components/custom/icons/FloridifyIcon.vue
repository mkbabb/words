<template>
  <div
    :class="
      cn(
        'flex cursor-pointer items-center transition-[transform,opacity] duration-normal ease-out',
        {
  ...
  >
    ...
    <FancyF
      ...
      class="transition-[transform,opacity] duration-normal"
    ...
    <span
      v-if="expanded"
      :class="
        cn('text-foreground font-serif text-xl transition-[transform,opacity,max-width] duration-normal', {
