<template>
  ...
  >
    <!-- Card container -->
    <div
      class="flex w-full max-w-md flex-col items-center rounded-2xl border border-border bg-card/80 p-8 backdrop-blur cartoon-shadow-sm"
    >
      <!-- Branding -->
      ...
      <!-- Clerk Sign In (renders when Clerk loads on the correct domain) -->
...
import { SignIn, ClerkLoaded } from '@clerk/vue';
