...
class TestDefinition:
    ...
    def test_definition_creation(self) -> None:
        ...
        definition = Definition(
            word_type=WordType.NOUN, definition="A representative case or instance"
        )
    ...
    def test_definition_with_examples(self) -> None:
        ...
        definition = Definition(
            word_type=WordType.NOUN, definition="A test definition", examples=examples
        )
...
class TestProviderData:
    ...
    def test_synthetic_provider_data(self) -> None:
        ...
        definition = Definition(word_type=WordType.VERB, definition="To demonstrate or illustrate")
        provider_data = ProviderData(
            provider_name="ai", definitions=[definition], is_synthetic=True
        )
