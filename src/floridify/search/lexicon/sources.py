...
from .protocols import DownloaderFunc, default_downloader
...
class LexiconSourceConfig(BaseModel):
    ...
    downloader: DownloaderFunc = Field(
        default=default_downloader,
        description="Downloader function (default: simple GET)",
        exclude=True,
    )
...
LEXICON_SOURCES = [
    ...
    LexiconSourceConfig(
        ...
        downloader=scrape_french_expressions
    ),
