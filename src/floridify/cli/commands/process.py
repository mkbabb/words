...
from ..utils.formatting import format_error, format_processing_summary, format_success
...
def process_file(
    input_file: str, output: str | None, output_format: str, deduplicate: bool, validate: bool
) -> None:
...
async def _process_file_async(
    ...
    try:
        ...
        console.print(format_processing_summary(len(words), successful, failed, input_file))
...
def clean_wordlist(
    input_file: str, output: str | None, min_length: int, max_length: int, alpha_only: bool
) -> None:
