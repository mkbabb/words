...
class MerriamWebsterConnector(DictionaryConnector):
    ...
    def _parse_pronunciation(self, data: dict[str, Any], word_id: PydanticObjectId) -> Pronunciation | None:
    ...
    async def _parse_definitions(self, data: dict[str, Any], word_id: PydanticObjectId) -> list[Definition]:
