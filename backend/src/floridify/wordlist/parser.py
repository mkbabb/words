...
def _looks_like_phrase(text: str) -> bool:
    ...
    phrase_indicators = {
        ...
        "la", "le", "de", "du", "des", "il", "et", "en",  # Common French
        "el", "la", "los", "las", "y", "o", "del",  # Common Spanish
    }
    ...
    common_phrases = {
        "quid pro quo", "carpe diem", "et cetera", "ad hoc", "per se",
        "vice versa", "status quo", "modus operandi", "alma mater",
        "bona fide", "de facto", "prima facie", "pro bono", "sine qua non",
        "coup de grace", "deja vu", "faux pas", "raison d'etre",
        "au revoir", "bon appetit", "c'est la vie", "joie de vivre",
    }
...
def parse_csv_file(path: Path) -> ParsedWordList:
    ...
    with open(path, newline="", encoding="utf-8") as f:
        ...
        for i, row in enumerate(reader):
            ...
            if i == 0 and row[0]:
                # Common header words
                header_words = {"word", "words", "term", "terms", "vocabulary", "name", "text", "entry"}
