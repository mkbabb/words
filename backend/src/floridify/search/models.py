...
class CorpusMetadata(Document, BaseMetadata):
    ...
    vocabulary_hash: str = Field(..., description="Content-based hash for cache invalidation")
...
class SemanticMetadata(Document, BaseMetadata):
    ...
    vocabulary_hash: str = Field(..., description="Hash of the vocabulary for cache invalidation")
    ...
    # Corpus metadata
    vocabulary_size: int = Field(..., description="Number of unique terms in vocabulary")
...
class SearchResult(BaseModel):
    ...
    method: SearchMethod = Field(..., description="Search method used (exact, fuzzy, semantic)")
