...
class SageMakerDeployer:
    ...
    def __init__(
        ...
        self.training_image = f"{self.account_id}.dkr.ecr.{region}.amazonaws.com/{ecr_repo_name}:training"
        self.inference_image = f"{self.account_id}.dkr.ecr.{region}.amazonaws.com/{ecr_repo_name}:inference"
    ...
    async def deploy_training_job(
        ...
        training_config = {
            ...
            "OutputDataConfig": {
                "S3OutputPath": f"s3://{s3_bucket}/wotd-models/"
            },
            "ResourceConfig": {
