...
from .constants import (
    DEFAULT_EMBEDDING_DIM, DEFAULT_EMBEDDING_MODEL, DEFAULT_LANGUAGE_MODEL,
    DEFAULT_NUM_CORPORA, DEFAULT_WORDS_PER_CORPUS, LM_EPOCHS, 
    LM_LEARNING_RATE, LM_MAX_LENGTH, LORA_ALPHA, LORA_DROPOUT, LORA_RANK,
    NORMALIZE_EMBEDDINGS, RVQ_CODEBOOK_SIZE, RVQ_ENCODER_EPOCHS, 
    RVQ_ENCODER_LR, RVQ_NUM_LEVELS
)
...
SemanticID = tuple[int, int, int, int]  # [style, complexity, era, variation] - 4D discrete preference space
