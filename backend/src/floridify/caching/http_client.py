    ...
    async def get(
        ...
        **kwargs: Any,
        ...
        if progress_callback:
            progress_callback(
                "connecting", {"url": url, "method": "GET", "cache_enabled": not should_force}
            )
        ...
        try:
            if (
                ...
                and "cache" in response.extensions
            ):
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if not should_force and file_path.exists():
                # Check file age
                file_age_hours = (file_path.stat().st_mtime - file_path.stat().st_ctime) / 3600
                ttl_hours = ttl_hours or self.default_ttl_hours
            ...
            def file_progress_callback(stage: str, metadata: dict[str, Any]) -> None:
