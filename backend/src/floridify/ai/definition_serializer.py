...
def serialize_definition_for_ai(
    definition: Definition, include_examples: bool = False
) -> dict[str, Any]:
...
def prepare_definitions_for_synthesis(
    definitions: list[Definition], max_definitions: int = 10
) -> list[dict[str, Any]]:
