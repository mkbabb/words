...
def get_temperature_for_model(model: ModelTier, task_name: str | None = None) -> float | None:
    ...
    if task_name:
        ...
        creative_tasks = {
            "generate_facts", "generate_examples", "suggest_words",
            "generate_suggestions", "generate_anki_best_describes",
        ...
        classification_tasks = {
            "assess_frequency", "assess_cefr_level", "classify_domain",
            "classify_register", "validate_query"
        }
