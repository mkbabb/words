...
class StateTracker:
    ...
    def __init__(self, callback: Optional[Callable[[StateUpdate], None]] = None):
    ...
    def get_stage_duration_ms(self, stage: PipelineStage) -> Optional[float]:
    ...
    def get_latest_update(self) -> Optional[StateUpdate]:
