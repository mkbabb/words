...
class ProviderDataRepository(BaseRepository[VersionedProviderData]):
    """Repository for versioned provider data operations."""
    
    model = VersionedProviderData
    ...
    async def get_latest(
        ...
        Returns:
            Latest VersionedProviderData or None
        """
    ...
    async def get_by_version(
        ...
        Returns:
            VersionedProviderData for specific version or None
        """
        return await self.model.find_one(
            {
                "word_id": word_id,
    ...
    async def get_by_date(
        ...
        Returns:
            VersionedProviderData active at that date
        """
        return await self.model.find_one(
            {
                "word_id": word_id,
    ...
    async def mark_as_latest(
        ...
        Args:
            data_id: ID of VersionedProviderData to mark as latest
    ...
    async def cleanup_old_versions(
        ...
        for word_doc in word_ids:
            ...
            versions = await self.model.find(
...
class BatchOperationRepository(BaseRepository[BatchOperation]):
    ...
    async def get_operation_stats(
        ...
        stats = {
            ...
            "success_rate": (
                (operation.processed_items - operation.failed_items) / operation.processed_items * 100
