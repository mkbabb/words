...
async def test_connector_comprehensive(connector_class, name, test_word, **init_kwargs):
    ...
    try:
        ...
        if result1:
            ...
            if versioned1:
                print(
                    f"    ✓ Saved to versioned storage v{versioned1.version_info.provider_version}"
                )
...
async def run_all_tests():
    ...
    try:
        ...
        if platform.system() == "Darwin":
            ...
            result = await test_connector_comprehensive(
                AppleDictionaryConnector, "Apple Dictionary", "apple"
            )
    ...
    try:
        ...
        result = await test_connector_comprehensive(
            WordHippoConnector, "WordHippo Scraper", "computer"
        )
    ...
    try:
        ...
        result = await test_connector_comprehensive(
            FreeDictionaryConnector, "Free Dictionary API", "hello"
        )
    ...
    try:
        ...
        result = await test_connector_comprehensive(
            WiktionaryConnector, "Wiktionary Scraper", "example"
        )
