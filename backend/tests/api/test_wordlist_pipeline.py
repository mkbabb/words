...
class TestWordlistPipelineAPI:
    ...
    @pytest.mark.asyncio
    async def test_list_wordlists_with_filtering(
        self,
    ...
    @pytest.mark.asyncio
    async def test_get_wordlist_details(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_add_words_to_wordlist(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_remove_word_from_wordlist(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_search_words_in_wordlist(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_wordlist_review_system(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_bulk_word_review(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_study_session_recording(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
    ...
    @pytest.mark.asyncio
    async def test_wordlist_statistics(
        self,
        async_client: AsyncClient,
        wordlist_factory
    ):
