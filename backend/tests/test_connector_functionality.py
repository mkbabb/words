...
class TestWordHippoConnectorLogic:
    ...
    def test_url_construction(self):
        ...
        word = "example"
        expected_pattern = f"{connector.base_url}/what-is/the-meaning-of-the-word/{word.lower()}.html"
    ...
    def test_part_of_speech_mappings(self):
        ...
        for abbrev, full_form in pos_mappings.items():
            ...
            assert full_form in ["noun", "verb", "adjective", "adverb", "preposition", "conjunction", "pronoun", "interjection"]
...
class TestRateLimitingConfiguration:
    ...
    def test_connector_rate_limit_configs(self):
        ...
        assert apple.config.rate_limit_config.base_requests_per_second >= wordhippo.config.rate_limit_config.base_requests_per_second
