"""Mock fixtures, factories, and test helpers for API tests.

pytest discovers conftest.py files in subdirectories automatically --
no import changes needed. Tests in tests/ and below will see both
the root conftest (MongoDB infra) and these fixtures.
"""
